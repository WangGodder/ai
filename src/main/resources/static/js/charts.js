...
class Charts{
    ...
    createCanvas(chartDiv) {
        ...
        chartDiv.append(canvasDiv);
        $("#canvasDiv_" + this._id).append(canvas);
    }

    createOptions(chartDiv) {
     ...
     */
    createDOM() {
        const chartDivHtml = $("<div id='chartDiv_" + this._id + "' class='" + canvasDir_style + "' ></div>");
        ...
        chartsDiv.append(chartDivHtml);
        const chartDiv = $("#chartDiv_" + this._id);
        // $("#chartDiv_" + this._id).append(canvasDiv);
        // $("#canvasDiv_" + this._id).append(canvas);
        // $("#chartDiv_" + this._id).append(optionsDiv);

        this.createCanvas(chartDiv);
        this.createOptions(chartDiv);
